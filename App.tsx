...
const App: React.FC = () => {
    ...
    // --- Handlers ---
    const onCharacterComplete = async (name: string, charClass: string, stats: BaseStats, feat: Feat, subclass?: string) => {
        const result = await handleCharacterComplete(name, charClass, stats, feat, subclass);
